            ...
            <nav class="site-navigation position-relative text-right" role="navigation">
              ...
              <ul class="site-menu main-menu js-clone-nav mr-auto d-none d-lg-block">
                ...
                <li class="has-children">
                  <a href="prevention.blade.php" class="nav-link">Prevention</a>
                  <ul class="dropdown">
                ...
                <li><a href="symptoms.blade.php" class="nav-link">Symptoms</a></li>
                <li><a href="about.blade.php" class="nav-link">About</a></li>


                <li class="active"><a href="blog.blade.php" class="nav-link">Blog</a></li>
